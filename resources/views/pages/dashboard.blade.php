...
<div class="tray tray-center">
	...
	<div class="panel">
		...
		<div class="panel-body pn">
			<div id="employee_chart1" style="height: 300px;"></div>
		</div>
	</div>
	...
	<div class="panel">
		<div class="panel-heading">
			...
			<ul class="nav panel-tabs panel-tabs-merge">
				<li class="active">
					<a href="{{url('employee_dashboard')}}#tab1_1" data-toggle="tab"> Top Sellers</a>
				</li>

				<li>
					<a href="{{url('employee_dashboard')}}#tab1_2" data-toggle="tab"> Most Viewed</a>
				</li>

				<li>
					<a href="{{url('employee_dashboard')}}#tab1_3" class="hidden-xs" data-toggle="tab"> New Customers</a>
				</li>
			</ul>
		</div>
							...
							<td class="text-right">
								<div class="btn-group text-right">
									...
									<ul class="dropdown-menu" role="menu">
										<li>
											<a href="{{url('employee_dashboard')}}#">Edit</a>
										</li>

										<li>
											<a href="{{url('employee_dashboard')}}#">Delete</a>
										</li>

										<li>
											<a href="{{url('employee_dashboard')}}#">Archive</a>
										</li>

										<li class="divider"></li>

										<li>
											<a href="{{url('employee_dashboard')}}#">Complete</a>
										</li>

										<li class="active">
											<a href="{{url('employee_dashboard')}}#">Pending</a>
										</li>

										<li>
											<a href="{{url('employee_dashboard')}}#">Canceled</a>
										</li>
									</ul>
								</div>
							</td>
