...
<body class="employee-page">
  ...
  <!-- FIRST LINE -->
                      ...
                      <td class="text-center">
                        <div class="btn-group">
                          <button type="button" class="btn btn-xs br2 fs12 btn-danger"> Declined
                          </button>
                        </div>
                      </td>
                    </tr>
  ...
  <!-- SECOND LINE -->
                      ...
                      <td class="text-center">
                        <div class="btn-group">
                          <button type="button" class="btn btn-danger br2 btn-xs fs12"> Declined
                          </button>
                        </div>
                      </td>
                    </tr>
  ...
  <!-- THIRD LINE -->
                    ...
                    <tr>
                      ...
                      <td class="text-center">
                        <div class="btn-group text-right">
                          <button type="button" class="btn btn-danger br2 btn-xs fs12 dropdown-toggle"> Declined
                          </button>
                        </div>
                      </td>
                    </tr>
